...
<div class="container-fluid">
    <nav class="navbar navbar-default">
        <div class="navbar-header">
            <h1><a class="navbar-brand" href="index.php" style="color:mediumseagreen">WB<span>PPS</span><p class="logo_w3l_agile_caption" style="color:green">Web-based Peoples Organization System</p></a></h1>
            ...
            <div class="login-avatar">
                ...
                <form action="validate/login.php" method="post" id="user">
                    ...
                    <div class="form-group has-feedback">
                        <input type="password" class="form-control" style="border-radius:10px" placeholder="Password" name="password" id="password" required>
                        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                    </div><br>
                    <div class="row">
                    <div class="col-xs-12 col-lg-12" style="width:100%;">
                        <center><button type="button" id="login" class="btn btn-success btn-flat" style="width:35%; height:35px; border-radius:10px; padding-top:3px;" name="login"><b>Log In</b></button></center>
                    </div>
