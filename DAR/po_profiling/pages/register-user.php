...
<html lang="en">
    ...
    <body class="skin-green fixed sidebar-mini sidebar-mini-expand-feature hold-transition">
                                                ...
                                                <select class="form-control" id="position" name="position">
                                                    <?php
                                                        if($_SESSION['role'] == 'PARPO I' || $_SESSION['role'] == 'PARPO II') {
                                                            $sql = 'SELECT distinct(id), description FROM user_position WHERE id in (7,2,3,6)';
                                                        } else {
                                                            $sql = 'SELECT distinct(id), description FROM user_position WHERE id in (7,6)';
                                                        }
        ...
        <script src="../js/register-user2.js"></script>
        <script>
            show_barangay();
