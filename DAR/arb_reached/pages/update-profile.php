                ...
                <section class="content">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <form method="post" role="form" id="update-user" novalidate enctype="multipart/form-data" action="controller/updateprofile.php" autocomplete="false">
                                            ...
                                            <div class="input-group" style="width:100%;">
                                                ...
                                                <?php
                                                    ...
                                                    if($_SESSION['role'] == 'PARPO I' || $_SESSION['role'] == 'PARPO II') {
                                                        $sql = 'SELECT distinct(id), description FROM user_position WHERE id != ?';
                                                    } else {
                                                        $sql = 'SELECT distinct(id), description FROM user_position WHERE id not in (7,2,3,1,?)';
                                                    }
                                                    $sql = $conn->prepare($sql);
                                                    $sql->bind_param('i',$user_pos_id);
                                                    $sql->execute();
                                                    $sql->bind_result($id,$position);
                                                    $sql->store_result();
                                                    if($sql->num_rows() > 0) {
                                                        while($sql->fetch()) {
